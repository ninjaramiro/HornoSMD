...
* Definiciones varias
*****************************************************************************/
//#define	UBRR0								25//(103)								/**< \brief UBRR para una velocidad de transmisión de 38400(9600)kbps con: fosc = 16MHz, U2X = 0 */
#define VALOR_U2X0							0
#define	USART0_BUFFER_ZISE					200										/**< \brief tamaño máximo del buffer de datos del USART */
#define TIMEOUT_ESPERA_USART_0				2//1//8mseg								/**< \brief timepo de timeout de espera para USART en cilclos del timer2 */
#define TIMEOUT_TX_USART_0					2//1//8mseg								/**< \brief tiempo de timeout para transmision del buffer por USART en cilclos del timer2 */
...
#define TIMEOUT_RX_USART_0					7500//3750//30000mseg					/**< \brief tiempo de timeout para recepcion de USART, cierra el buffer de recepcion si no recive en ese tiempo, en cilclos del timer2 */
...
// *	El envío se da por finalizado al encontrar el primer caracter NULL ('\0') o '\n' o '\r', segun configuracion, o al llegar a la máxima dimensión permitida \n
