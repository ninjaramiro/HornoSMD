...
#ifdef LCD_TYPE_162
	#define LCD_TYPE_204
	#define LCD_VISIBLE_LINE_WITH 16
#endif

#ifdef LCD_TYPE_202
	#define LCD_TYPE_204
	#define LCD_VISIBLE_LINE_WITH 20
#endif
...
void LCDWriteLine(uint8_t line, const char *msg){
	...
	This function Writes a given line to lcd at the begining of
	the line. If the string is smoller of the line size, it complete
