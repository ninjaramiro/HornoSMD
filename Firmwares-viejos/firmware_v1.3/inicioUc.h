...
#define	PIN_TECLADO_COMUN		PA0
#define	PIN_TECLADO_1			PA1
#define	PIN_TECLADO_2			PA2
#define	PIN_TECLADO_3			PA3

#define JUMPER_PORT				PORTA
#define JUMPER_PIN				PINA
#define DIR_JUMPER_PORT 		DDRA
#define	PIN_JUMPER_OUT			PA4
#define	PIN_JUMPER_IN			PA5
