...
* Inicio Timer 2
************************************************************************/
/* Inicio el Timer para generar 1.008kHz para la medicion de los conductimetros */

void Inicio_Timer2 (void) {
	TCCR2 = (OFF<<FOC2)|(ON<<WGM21)|(OFF<<WGM20)|(OFF<<COM21)|(ON<<COM20)|(OFF<<CS22)|(ON<<CS21)|(ON<<CS20);
	OCR2 = 61;
}
